        ...
        server_oauth2_form_error!(&server, audit, &client, &template, async {
            ...
            let body = match query {
                ...
                AuthDeleteQueryParse::Accept(code) => {
                    ...
                    TEMPLATE_AUTH_DELETE_ACCEPT_OK
                }
                AuthDeleteQueryParse::Reject(code) => {
                    ...
                    TEMPLATE_AUTH_DELETE_REJECT_OK
                }
            };
...
impl AuthDeleteQueryParse {
    fn template_get(&self) -> &'static str {
        match self {
            Self::Request => TEMPLATE_AUTH_DELETE,
            Self::Accept(_) => TEMPLATE_AUTH_DELETE_ACCEPT,
            Self::Reject(_) => TEMPLATE_AUTH_DELETE_REJECT,
        }
    }
