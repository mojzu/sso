...
const errorHbs = fs.readFileSync(
    path.normalize("../sso/server/template/error.hbs"),
    { encoding: "utf8" }
);
const authHbs = fs.readFileSync(
    path.normalize("../sso/server/template/auth.hbs"),
    { encoding: "utf8" }
);
const passwordResetRequestHbs = fs.readFileSync(
    path.normalize("../sso/server/template/password_reset/request.hbs"),
    { encoding: "utf8" }
);
const passwordResetAcceptHbs = fs.readFileSync(
    path.normalize("../sso/server/template/password_reset/accept.hbs"),
    { encoding: "utf8" }
);
const passwordResetAcceptOkHbs = fs.readFileSync(
    path.normalize("../sso/server/template/password_reset/accept_ok.hbs"),
    { encoding: "utf8" }
);
const passwordResetRejectHbs = fs.readFileSync(
    path.normalize("../sso/server/template/password_reset/reject.hbs"),
    { encoding: "utf8" }
);
const passwordResetRejectOkHbs = fs.readFileSync(
    path.normalize("../sso/server/template/password_reset/reject_ok.hbs"),
    { encoding: "utf8" }
);
const emailUpdateRequestHbs = fs.readFileSync(
    path.normalize("../sso/server/template/email_update/request.hbs"),
    { encoding: "utf8" }
);
const emailUpdateRequestOkHbs = fs.readFileSync(
    path.normalize("../sso/server/template/email_update/request_ok.hbs"),
    { encoding: "utf8" }
);
const passwordUpdateRequestHbs = fs.readFileSync(
    path.normalize("../sso/server/template/password_update/request.hbs"),
    { encoding: "utf8" }
);
const passwordUpdateRequestOkHbs = fs.readFileSync(
    path.normalize("../sso/server/template/password_update/request_ok.hbs"),
    { encoding: "utf8" }
);
const registerRequestHbs = fs.readFileSync(
    path.normalize("../sso/server/template/register/request.hbs"),
    { encoding: "utf8" }
);
const registerAcceptHbs = fs.readFileSync(
    path.normalize("../sso/server/template/register/accept.hbs"),
    { encoding: "utf8" }
);
const registerAcceptOkHbs = fs.readFileSync(
    path.normalize("../sso/server/template/register/accept_ok.hbs"),
    { encoding: "utf8" }
);
const registerRejectHbs = fs.readFileSync(
    path.normalize("../sso/server/template/register/reject.hbs"),
    { encoding: "utf8" }
);
const registerRejectOkHbs = fs.readFileSync(
    path.normalize("../sso/server/template/register/reject_ok.hbs"),
    { encoding: "utf8" }
);
const logoutHbs = fs.readFileSync(
    path.normalize("../sso/server/template/logout.hbs"),
    { encoding: "utf8" }
);
const deleteRequestHbs = fs.readFileSync(
    path.normalize("../sso/server/template/delete/request.hbs"),
    { encoding: "utf8" }
);
const deleteAcceptHbs = fs.readFileSync(
    path.normalize("../sso/server/template/delete/accept.hbs"),
    { encoding: "utf8" }
);
const deleteAcceptOkHbs = fs.readFileSync(
    path.normalize("../sso/server/template/delete/accept_ok.hbs"),
    { encoding: "utf8" }
);
const deleteRejectHbs = fs.readFileSync(
    path.normalize("../sso/server/template/delete/reject.hbs"),
    { encoding: "utf8" }
);
const deleteRejectOkHbs = fs.readFileSync(
    path.normalize("../sso/server/template/delete/reject_ok.hbs"),
    { encoding: "utf8" }
);
