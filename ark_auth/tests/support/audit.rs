        ...
        fn api_audit_list_created_ok() {
            ...
            let res1 = client
                .audit_list(AuditListQuery {
                    gt: None,
                    lt: None,
                    created_gte: Some(a1.created_at),
                    created_lte: None,
                    offset_id: None,
                    limit: Some(limit.to_owned()),
                })
            ...
            let res3 = client
                .audit_list(AuditListQuery {
                    gt: None,
                    lt: None,
                    created_gte: Some(a2.created_at),
                    created_lte: None,
            ...
            let res4 = client
                .audit_list(AuditListQuery {
                    ...
                    lt: None,
                    created_gte: None,
                    created_lte: Some(a5.created_at),
            ...
            let res5 = client
                .audit_list(AuditListQuery {
                    ...
                    lt: None,
                    created_gte: None,
                    created_lte: Some(a4.created_at),
        ...
        fn api_audit_list_created_and_ok() {
            ...
            let res2 = client
                .audit_list(AuditListQuery {
                    ...
                    lt: None,
                    created_gte: Some(a1.created_at),
                    created_lte: Some(a3.created_at),
                    offset_id: Some(a1.id),
                    limit: Some(limit.to_owned()),
                })
                .unwrap();
