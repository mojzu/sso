...
pub mod request_api_key_create {
    include!("./request_api_key_create.rs");
}

pub mod request_api_key_delete {
    include!("./request_api_key_delete.rs");
}

pub mod request_api_key_read {
    include!("./request_api_key_read.rs");
}

pub mod request_api_key_update {
    include!("./request_api_key_update.rs");
}

pub mod request_api_key_verify {
    include!("./request_api_key_verify.rs");
}

pub mod request_audit_create {
    include!("./request_audit_create.rs");
}

pub mod request_audit_read {
    include!("./request_audit_read.rs");
}

pub mod request_csrf {
    include!("./request_csrf.rs");
}

pub mod request_oauth2_introspect {
    include!("./request_oauth2_introspect.rs");
}

pub mod request_oauth2_token {
    include!("./request_oauth2_token.rs");
}

pub mod request_user_access_read {
    include!("./request_user_access_read.rs");
}

pub mod request_user_create {
    include!("./request_user_create.rs");
}

pub mod request_user_delete {
    include!("./request_user_delete.rs");
}

pub mod request_user_read {
    include!("./request_user_read.rs");
}

pub mod request_user_update {
    include!("./request_user_update.rs");
}

pub mod response_access {
    include!("./response_access.rs");
}

pub mod response_access_many {
    include!("./response_access_many.rs");
}

pub mod response_api_key {
    include!("./response_api_key.rs");
}

pub mod response_api_key_many {
    include!("./response_api_key_many.rs");
}

pub mod response_audit {
    include!("./response_audit.rs");
}

pub mod response_audit_many {
    include!("./response_audit_many.rs");
}

pub mod response_client {
    include!("./response_client.rs");
}

pub mod response_csrf {
...
pub mod response_user_many {
    include!("./response_user_many.rs");
}
